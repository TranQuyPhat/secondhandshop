        ...
        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
            <div class="wrap-product-detail">
                ...
                <div class="detail-info">
                    ...
                    <!-- && $sale->status == 1 $sale->sale_date > Carbon\Carbon::now() -->
                  ...
                  @else 
                    ...
                    <div class="wrap-butons">
                        ...
                        <div class="wrap-btn">
                            ...
                            <a href="#" class="btn btn-wishlist">Thêm vào mục yêu thích</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tab-contents">
                        ...
                        <div class="tab-content-item " id="review">
                            ...
                            <div class="wrap-review-form">
                                ...
                                <div id="comments">
                                    <h2 class="woocommerce-Reviews-title">01 Đánh giá cho sản phẩm  <span>{{$product->name}}</span></h2>
                    ...
                    <ul class="our-services">
                        ...
                        <li class="service">
                            <a class="link-to-service" href="#">
                                ...
                                <div class="right-content">
                                    ...
                                    <span class="subtitle">Đối với đơn hàng trên $99</span>
                        ...
                        <li class="service">
                            <a class="link-to-service" href="#">
                                ...
                                <div class="right-content">
                                    ...
                                    <span class="subtitle">Cơ hội nhận quà từ shop</span>
                        ...
                        <li class="service">
                            <a class="link-to-service" href="#">
                                ...
                                <div class="right-content">
                                    <b class="title">Trả lại đơn hàng</b>
                                    <span class="subtitle">Trở lại trong vòng 7 ngày</span>
